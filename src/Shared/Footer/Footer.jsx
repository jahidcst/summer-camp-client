  ...
  return (
    <div className="mt-24">
      <div className="bg-[#032E3F] text-white">
        <div className="max-w-screen-xl mx-auto lg:flex justify-between p-10 lg:py-20 ">
          <div>
            ...
            <hr />
            <div className="mt-4">
              <h4 className="text-2xl my-4 flex gap-2 items-center"><FaGraduationCap className="text-3xl"/>Language Center</h4>
              <p>
                {" "}
      ...
      <div className="bg-[#FF7350]">
       ...
       <h1 className="text-2xl font-bold hidden lg:flex items-center gap-2"><FaGraduationCap className="text-4xl"/> Language Center</h1>
